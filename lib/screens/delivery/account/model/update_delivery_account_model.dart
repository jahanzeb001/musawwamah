...
//
//     final updateDeliveryAccountResponse = updateDeliveryAccountResponseFromJson(jsonString);

import 'dart:convert';

UpdateDeliveryAccountResponse updateDeliveryAccountResponseFromJson(
        String str) =>
    UpdateDeliveryAccountResponse.fromJson(json.decode(str));

String updateDeliveryAccountResponseToJson(
        UpdateDeliveryAccountResponse data) =>
    json.encode(data.toJson());

class UpdateDeliveryAccountResponse {
  bool? success;
  String? message;
  Data? data;

  UpdateDeliveryAccountResponse({
    this.success,
    this.message,
    this.data,
  });

  factory UpdateDeliveryAccountResponse.fromJson(Map<String, dynamic> json) =>
      UpdateDeliveryAccountResponse(
