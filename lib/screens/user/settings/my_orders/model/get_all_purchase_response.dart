...
//
//     final getAllPurchasResponse = getAllPurchasResponseFromJson(jsonString);

import 'dart:convert';

GetAllPurchasResponse getAllPurchasResponseFromJson(String str) =>
    GetAllPurchasResponse.fromJson(json.decode(str));

String getAllPurchasResponseToJson(GetAllPurchasResponse data) =>
    json.encode(data.toJson());

class GetAllPurchasResponse {
  GetAllPurchasResponse({
    this.success,
    this.message,
    this.data,
  });
  ...
  factory GetAllPurchasResponse.fromJson(Map<String, dynamic> json) =>
      GetAllPurchasResponse(
