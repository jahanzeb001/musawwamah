...
//
//     final modifyHorseResponse = modifyHorseResponseFromJson(jsonString);

import 'dart:convert';

ModifyHorseResponse modifyHorseResponseFromJson(String str) =>
    ModifyHorseResponse.fromJson(json.decode(str));

String modifyHorseResponseToJson(ModifyHorseResponse data) =>
    json.encode(data.toJson());

class ModifyHorseResponse {
  bool? success;
  String? message;
  Data? data;
  ...
  factory ModifyHorseResponse.fromJson(Map<String, dynamic> json) =>
      ModifyHorseResponse(
