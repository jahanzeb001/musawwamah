...
//
//     final addToFavouriteResponse = addToFavouriteResponseFromJson(jsonString);

import 'dart:convert';

AddToFavouriteResponse addToFavouriteResponseFromJson(String str) =>
    AddToFavouriteResponse.fromJson(json.decode(str));

String addToFavouriteResponseToJson(AddToFavouriteResponse data) =>
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        moreImages: json["moreImages"] == null
            ? []
            : List<dynamic>.from(json["moreImages"]!.map((x) => x)),
