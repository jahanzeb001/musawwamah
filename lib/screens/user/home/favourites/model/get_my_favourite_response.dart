...
//
//     final getMyFavouriteResponse = getMyFavouriteResponseFromJson(jsonString);

import 'dart:convert';

import 'package:get/get.dart';

GetMyFavouriteResponse getMyFavouriteResponseFromJson(String str) =>
    GetMyFavouriteResponse.fromJson(json.decode(str));

String getMyFavouriteResponseToJson(GetMyFavouriteResponse data) =>
    json.encode(data.toJson());

class GetMyFavouriteResponse {
  bool? success;
  String? message;
  List<Datum>? data;

  GetMyFavouriteResponse({
    this.success,
    this.message,
    this.data,
  });

  factory GetMyFavouriteResponse.fromJson(Map<String, dynamic> json) =>
      GetMyFavouriteResponse(
