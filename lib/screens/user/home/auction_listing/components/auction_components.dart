...
import 'package:obaiah_mobile_app/screens/user/home/auction_listing/controller/auction_controller.dart';
          ...
          child: Column(
            ...
            children: <Widget>[
                ...
                children: [
                  Expanded(
                    child: BidPaymentBoxComponent(
                        text:
                            "${auctionListingController.addInsuranceController.text}",
                        headerText: "amount",
                        color: cWhiteColor),
                  ),
                  Expanded(
                    child: BidPaymentBoxComponent(
                        text: "${auctionListingController.userBalance}",
              ...
              ReusablePaymentActionWidget(
                ...
                userid: auctionListingController.userId,
                horseid: auctionListingController.horsesId,
                sellerid: '',
                totalprice:
                    auctionListingController.addInsuranceController.text,
                role: 'addinsurence',
